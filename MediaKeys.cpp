/*
MediaKeys.cpp - library - implementation
...
void Media_::write(uint16_t command){
...
const u8 _hidReportDescriptor[] = {
  ...
  0x95, 0x01,                    //   REPORT_COUNT (1)
  0x75, 0x08,                    //   REPORT_SIZE (8)
  0x81, 0x03,                    //   INPUT (Cnst,Var,Abs) //delete reserved <--

  0x95, 0x06,                    //   REPORT_COUNT (6) //delete these, only one key <--
  0x75, 0x08,                    //   REPORT_SIZE (8)
  0x15, 0x00,                    //   LOGICAL_MINIMUM (0)
  ...
  //================================================================================
  //added and modified by NicoHood
